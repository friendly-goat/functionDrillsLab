...
console.log(exclaimThree('test test'));
...
const nameGreeting = function nameCheck (name){
  if(name == 'Steven'){
...
console.log(nameGreeting('Bryan'));
...
const oddChecker = function thatsOdd (num) {
  if(num % 2 == 0){
...
const bestMovie = movieT => {
  return `${movieT} is the best movie ever!`
}
...
console.log(emailCheck('    dsfsdf@gmail.com'))
////////////////// PROBLEM 19 ////////////////////
/*
...
const totalFrogs = function store (usrGold) {
  numFrogs = Math.round(usrGold / 3);
  remainingGold = usrGold % 3;
  console.log(`You got ${numFrogs} Frogs, and have ${remainingGold} gold left over`)
  return numFrogs;
}
alexGold = 4;
totalFrogs(alexGold)
